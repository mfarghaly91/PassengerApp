...
export default function Drivers() {
  ...
  return (
    <div className="p-8 space-y-6">
        ...
        <Table>
          ...
          <TableBody>
            {isLoading ? (
              ...
              filtered.map((driver) => (
                <TableRow key={driver.id} className="hover:bg-muted/40 transition-colors">
                  <TableCell>
                  ...
                  <TableCell className="text-right pr-6">
                    <Button 
                      ...
                      onClick={() => setViewDriverId(driver.id)}
                    >
      ...
      <Dialog open={viewDriverId !== null} onOpenChange={(open) => !open && setViewDriverId(null)}>
